...
public abstract class BaseSettingsPage extends GuiScreen {
    ...
    public void initPage(GuiScreen previousPage, GuiScreen nextPage) {
        ...
        if (previousPage!= null)
            addButton(-5, x - 45, y, small, "\u00A76<<", false, false, true);

        if (nextPage!= null)
            addButton(-6, x + 225, y, small, "\u00A76>>", false, false, true);
    }
    ...
    protected FBPGuiButton addButton(int id, int x, int y, String text, Boolean toggle, Boolean toggleButton, Boolean enabled) {
