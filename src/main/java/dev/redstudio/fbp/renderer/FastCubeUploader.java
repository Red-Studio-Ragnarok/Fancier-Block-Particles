...
public class FastCubeUploader {
    ...
    private static void putCube(long address, Matrix4f modelMatrix, Matrix3f normalMatrix, ITexCoordProvider texCoordProvider, IColorProvider colorProvider, ILightCoordProvider lightCoordProvider) {
        ...
        putQuad(address, EnumFacing.WEST, v000x, v000y, v000z, v001x, v001y, v001z, v011x, v011y, v011z, v010x, v010y, v010z, texCoordProvider, colorProvider, lightCoordProvider, (byte) -nxx, (byte) -nxy, (byte) -nxz);
        putQuad(address + 31 * 4, EnumFacing.EAST, v101x, v101y, v101z, v100x, v100y, v100z, v110x, v110y, v110z, v111x, v111y, v111z, texCoordProvider, colorProvider, lightCoordProvider, nxx, nxy, nxz);
